...
public class MustHaveMeeplesRuleTest {
    ...
    public void initializeInstances(){
        ...
        for(int i = 0; i < 30; i++)
        {
            testPlayerFailure.decrimentMeeples();
        }
    }
    ...
    public void testPlayerFailureShouldFail() throws InvalidPiecePlacementRuleException{
        MustHaveMeeplesRule.applyRule(testPlayerFailure);
    }

    @Test
    public void testPlayerSuccessShouldPass() throws InvalidPiecePlacementRuleException{
        MustHaveMeeplesRule.applyRule(testPlayerSuccess);
    }
}
