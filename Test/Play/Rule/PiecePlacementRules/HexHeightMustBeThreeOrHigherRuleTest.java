...
public class HexHeightMustBeThreeOrHigherRuleTest {
    ...
    private void whenICheckTheRule() throws InvalidPiecePlacementRuleException {
        HexHeightMustBeThreeOrHigherRule.applyRule(tileMap, movement.up(origin));
    }

    @Test
    public void ruleShouldPassSinceHexHeightIsThree() throws Exception {
        givenTheTileMapIsPopulatedUpToHeightThree();
        whenICheckTheRule();
    }

    private void givenTheTileMapIsPopulatedUpToHeightThree() throws Exception {
        givenTheTileMapIsPopulatedUpToHeightTwo();
